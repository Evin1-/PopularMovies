...
public class Result implements Parcelable {
    ...
    public Result(String posterPath, String overview, String releaseDate, int id, String title, String backdropPath, double popularity, double voteAverage) {
    ...
    public static Result buildResult(Cursor cursor) {
        return new Result(
                ...
                cursor.getString(cursor.getColumnIndex(MoviesContract.FavoriteEntry.COLUMN_SYNOPSIS)),
